            ...
            <div className="flex gap-3">
              {[Linkedin, Twitter, Facebook, Instagram].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-xl bg-[#063b39] text-[#b99b6d] flex items-center justify-center hover:bg-[#d4b16a] hover:text-[#042f2e] shadow-[0_0_10px_rgba(212,177,106,0.2)] hover:shadow-[0_0_20px_rgba(212,177,106,0.4)] transition-all duration-300"
                >
