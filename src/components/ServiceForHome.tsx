                  ...
                  >
                    ...
                    >
                      ...
                      <Button
                        ...
                        className="mt-5 text-xs sm:text-sm px-4 py-1.5 rounded-full
                           bg-teal-800 text-white cursor-pointer
                           hover:bg-gray-100 hover:text-teal-950 transition "
                      >See more</Button>
                    </motion.div>
                    ...
                    >
                      ...
                      <ul className="text-xs sm:text-sm md:text-base text-gray-700 space-y-2 sm:space-y-3">
                        {svc.points.map((p, idx) => (
                          <li key={idx} className="flex items-start gap-2 sm:gap-3">
                            <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 mt-0.5 text-teal-800 flex-shrink-0" />
                      ...
                      className="mt-6 text-sm text-teal-800 hover:underline mx-auto cursor-pointer"
                    >
                      Back
                    </button>
                    </motion.div>
